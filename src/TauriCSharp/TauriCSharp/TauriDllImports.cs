...
// Changes: Namespace and class renames from Photino to Tauri
// Note: P/Invoke function names still reference Photino.Native until wry-ffi is ready
...
/// <summary>
/// The TauriWindow class represents a window in a Tauri-based desktop application.
/// </summary>
public partial class TauriWindow
{
    // TODO: Replace with "wry_ffi" when native layer is swapped
    ...
    [DllImport(DLL_NAME, CallingConvention = CallingConvention.Cdecl, SetLastError = true, CharSet = CharSet.Ansi)] static extern IntPtr Photino_ctor(ref TauriNativeParameters parameters);
    ...
    [LibraryImport(DLL_NAME, SetLastError = true, StringMarshalling = StringMarshalling.Utf8)]
    [UnmanagedCallConv(CallConvs = new Type[] { typeof(System.Runtime.CompilerServices.CallConvCdecl) })]
    public static partial TauriDialogResult Photino_ShowMessage(IntPtr inst, string title, string text, TauriDialogButtons buttons, TauriDialogIcon icon);
}
