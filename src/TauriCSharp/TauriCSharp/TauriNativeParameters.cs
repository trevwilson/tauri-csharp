...
internal struct TauriNativeParameters
{
    ...
    ///<summary>OPTIONAL: If native window is created from another native window, this is the pointer to the parent window. It is set automatically in WaitforExit().</summary>
    ...
    ///<summary>Checks the parameters to ensure they are valid before window creation. Called by TauriWindow prior to initializing native window.</summary>
